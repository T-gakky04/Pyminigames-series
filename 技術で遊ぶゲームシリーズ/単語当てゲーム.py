...
#正誤判定と残りライフ数を管理する処理
def check_guess_and_update_display(guess, miss_count, target_word, display_word):
    #単語の正誤判定
    ...
    return miss_count, display_word
...
def main():
    ...
    while '_' in display_word:
        ...
        #単語の正誤判定
        miss_count, display_word = check_guess_and_update_display(guess, miss_count, target_word, display_word)
